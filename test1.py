...
win_image = face.load_image_file("win2.jpg")
win_face_encoding = face.face_encodings(win_image)[0]

win2_image = face.load_image_file("win1.jpg")
win2_face_encoding = face.face_encodings(win2_image)[0]
...
known_face_encodings = [win_face_encoding, win2_face_encoding]
known_face_names = ["Nawat", "Nawat"]
